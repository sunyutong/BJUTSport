...
class WebService {
    ...
    //登录界面URL
    static final String WEBSERVICE_WSDL_URL = "http://192.168.1.100:8080/BJUTSport/services/BJUTSportWebServiceImplPort?wsdl";
    //登录界面域名
    static final String WEBSERVICE_NAMESPACE = "http://services.bjutsport.com/";
    //登录界面方法名称:login
